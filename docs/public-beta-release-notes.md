...
DeusCFO is a local Path of Exile market research terminal for historical prices, evidence-quality signals, and paper decision support. This beta intentionally narrows its production route promise to the verified **Doctor → Headhunter** divination-card route.
